...
class PlayerCareer {
  ...
  calculateOvr() {
    ...
    if (this.profile.squadRole === "Bench Player" && this.profile.ovr >= 82) {
  ...
  recordMatchPerformance(goals, assists, passAccuracy, rating, compKey = "league") {
  ...
  advanceSeason() {
    ...
    if (window.leaguesEngine) {
      ...
      else if (stars === 5) callUpThreshold = 85;
